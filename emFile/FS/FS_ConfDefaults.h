...
*/
  ...
  #define FS_MAINTAIN_FAT_COPY                    1     // Shall the 2nd FAT (copy) be maintained.
#endif
...
*/
  ...
  #define FS_NOR_SUPPORT_ECC                      1       // If set to 1 the integrity of the management and sector data is protected by ECC.
#endif
...
*/
  ...
  #define FS_MMC_READ_DATA_TIMEOUT                200     // Number of milliseconds to wait for data from card (was originally 0 = maximum)
#endif
...
*/
  ...
  #define FS_LOGVOL_SUPPORT_DRIVER_MODE           1       // If set to 1 LOGVOL behaves like a normal logical driver that is instantiated via FS_AddDevice().
