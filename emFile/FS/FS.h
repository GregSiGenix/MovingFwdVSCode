...
extern const FS_NOR_SPI_TYPE FS_NOR_SPI_DeviceBYT;
...
extern const FS_NOR_SPI_DEVICE_LIST FS_NOR_SPI_DeviceListBYT;
...
#define FS_NOR_SPI_DeviceList_BYT                       FS_NOR_SPI_DeviceListBYT
