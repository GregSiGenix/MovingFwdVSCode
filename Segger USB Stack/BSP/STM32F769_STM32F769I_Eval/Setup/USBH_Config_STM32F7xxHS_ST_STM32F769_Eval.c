...
----------------------------------------------------------------------
File        : USBH_Config_STM32F7xxHS_ST_STM32F769_Eval.c
Purpose     : emUSB Host configuration file for the
              ST STM32F769 eval board
---------------------------END-OF-HEADER------------------------------
*/
...
void USBH_X_Config(void) {
  ...
  _InitUSBHw();
  USBH_STM32F7_HS_SetCacheConfig(&_CacheConfig, sizeof(_CacheConfig));  // Set cache configuration for USBH stack.
