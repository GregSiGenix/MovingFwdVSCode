...
----------------------------------------------------------------------
File        : USBH_Config_STM32F2xx_HS_ST_STM32F4x9I_EVAL.c
Purpose     : emUSB Host configuration file for the ST STM32 MB784 eval board
---------------------------END-OF-HEADER------------------------------
*/
...
#define ALLOC_SIZE                  0x4500      // Size of memory dedicated to the stack in bytes
